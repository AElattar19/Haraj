...
return [
    ...
    */
    ...
    'cdn' => env('SWEET_ALERT_CDN', '/vendor/sweetalert/sweetalert.all.js'),
    ...
    */
    ...
    'animatecss' => env('SWEET_ALERT_ANIMATECSS', '/dashboard/css/animate.css'),
